...
- [Mdtablerender](https://github.com/malys/silverbullet-libraries/blob/main/src/MdTableRender.md) - Automatically formats Markdown table cells based on hashtag column tags. - (2026-01-04)
...
- [Riskaudit](https://github.com/malys/silverbullet-libraries/blob/main/src/RiskAudit.md) - Risk audit  (scripts analyzor)
...
- [Debugger](https://github.com/malys/silverbullet-libraries/blob/main/src/Utilities/Debugger.md)
